...
export default function AddMenu() {
    ...
    return (
        <div>
            <div>
                <TextField name="menuItemName" label="Name" onChange={handleInputChange} />
            </div>
            <div>
                <TextField name="description" label="Description" onChange={handleInputChange} />
            </div>
            <div>
                <TextField name="price" label="Price" type="number" onChange={handleInputChange} />
            </div>
                <div> 
                <label>
            ...
            <div>
                <Button variant="contained" color="primary" onClick={saveMenu}>Add</Button>
            </div>
        </div>
    )
}
